...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LyraMaterial",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12LyraMaterial4View")
...
SWIFT_CLASS("_TtC12LyraMaterial3Bar")
@interface Bar : View
@property (nonatomic, readonly) CGSize intrinsicContentSize;
...
SWIFT_CLASS("_TtC12LyraMaterial6Button")
...
SWIFT_CLASS("_TtC12LyraMaterial19BaseIconLayerButton")
...
SWIFT_CLASS("_TtC12LyraMaterial26BottomNavigationController")
...
@interface CALayer (SWIFT_EXTENSION(LyraMaterial))
...
SWIFT_CLASS("_TtC12LyraMaterial9PulseView")
...
SWIFT_CLASS("_TtC12LyraMaterial4Card")
...
SWIFT_CLASS("_TtC12LyraMaterial22CardCollectionViewCell")
...
SWIFT_CLASS("_TtC12LyraMaterial14ViewController")
...
SWIFT_CLASS("_TtC12LyraMaterial28CardCollectionViewController")
...
@interface CardCollectionViewController (SWIFT_EXTENSION(LyraMaterial))
...
SWIFT_CLASS("_TtC12LyraMaterial11CheckButton")
...
SWIFT_CLASS("_TtC12LyraMaterial7ChipBar")
...
SWIFT_CLASS("_TtC12LyraMaterial20TransitionController")
...
SWIFT_CLASS("_TtC12LyraMaterial17ChipBarController")
...
SWIFT_CLASS("_TtC12LyraMaterial10FlatButton")
...
SWIFT_CLASS("_TtC12LyraMaterial8ChipItem")
...
SWIFT_CLASS("_TtC12LyraMaterial14CollectionView")
...
SWIFT_CLASS("_TtC12LyraMaterial24CollectionViewController")
...
@interface CollectionViewController (SWIFT_EXTENSION(LyraMaterial))
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView * _Nonnull)collectionView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC12LyraMaterial20CollectionViewLayout")
...
@interface CollectionViewLayout (SWIFT_EXTENSION(LyraMaterial))
...
SWIFT_CLASS("_TtC12LyraMaterial5Color")
...
SWIFT_CLASS("_TtC12LyraMaterial6Dialog")
...
SWIFT_PROTOCOL("_TtP12LyraMaterial14DialogDelegate_")
...
SWIFT_CLASS("_TtC12LyraMaterial10DialogView")
...
SWIFT_CLASS("_TtC12LyraMaterial6Editor")
...
SWIFT_CLASS("_TtC12LyraMaterial9TextField")
...
SWIFT_CLASS("_TtC12LyraMaterial14ErrorTextField")
...
SWIFT_CLASS("_TtC12LyraMaterial9FABButton")
...
@interface FABMenuController (SWIFT_EXTENSION(LyraMaterial)) <FABMenuDelegate>
@end
...
SWIFT_CLASS("_TtC12LyraMaterial11FABMenuItem")
...
SWIFT_CLASS("_TtC12LyraMaterial10IconButton")
...
SWIFT_CLASS("_TtC12LyraMaterial9ImageCard")
...
SWIFT_CLASS("_TtC12LyraMaterial13NavigationBar")
...
SWIFT_CLASS("_TtC12LyraMaterial20NavigationController")
...
@interface NavigationController (SWIFT_EXTENSION(LyraMaterial)) <UIGestureRecognizerDelegate>
...
@interface NavigationController (SWIFT_EXTENSION(LyraMaterial)) <UINavigationBarDelegate>
...
@interface NavigationDrawerController (SWIFT_EXTENSION(LyraMaterial)) <UIGestureRecognizerDelegate>
...
SWIFT_CLASS("_TtC12LyraMaterial13PresenterCard")
...
SWIFT_CLASS("_TtC12LyraMaterial11RadioButton")
...
SWIFT_CLASS("_TtC12LyraMaterial12RaisedButton")
...
SWIFT_CLASS("_TtC12LyraMaterial9SearchBar")
...
SWIFT_CLASS("_TtC12LyraMaterial19StatusBarController")
...
SWIFT_CLASS("_TtC12LyraMaterial19SearchBarController")
...
SWIFT_CLASS("_TtC12LyraMaterial8Snackbar")
...
SWIFT_CLASS("_TtC12LyraMaterial18SnackbarController")
...
SWIFT_CLASS("_TtC12LyraMaterial6Switch")
...
SWIFT_CLASS("_TtC12LyraMaterial6TabBar")
...
@interface TabBar (SWIFT_EXTENSION(LyraMaterial))
...
SWIFT_CLASS("_TtC12LyraMaterial7TabItem")
...
SWIFT_CLASS("_TtC12LyraMaterial9TableView")
...
SWIFT_CLASS("_TtC12LyraMaterial13TableViewCell")
...
SWIFT_CLASS("_TtC12LyraMaterial19TableViewController")
...
@interface TableViewController (SWIFT_EXTENSION(LyraMaterial))
...
SWIFT_CLASS("_TtC12LyraMaterial14TabsController")
...
SWIFT_CLASS("_TtC12LyraMaterial11TextStorage")
...
@interface TextStorage (SWIFT_EXTENSION(LyraMaterial))
...
SWIFT_CLASS("_TtC12LyraMaterial8TextView")
...
@interface TextView (SWIFT_EXTENSION(LyraMaterial)) <TextStorageDelegate>
- (void)textStorageWithTextStorage:(TextStorage * _Nonnull)textStorage willProcessEditing:(NSString * _Nonnull)text range:(NSRange)range;
- (void)textStorageWithTextStorage:(TextStorage * _Nonnull)textStorage didProcessEditing:(NSString * _Nonnull)text result:(NSTextCheckingResult * _Nullable)result flags:(NSMatchingFlags)flags stop:(BOOL * _Nonnull)stop;
@end
...
SWIFT_CLASS("_TtC12LyraMaterial7Toolbar")
...
@interface UIView (SWIFT_EXTENSION(LyraMaterial))

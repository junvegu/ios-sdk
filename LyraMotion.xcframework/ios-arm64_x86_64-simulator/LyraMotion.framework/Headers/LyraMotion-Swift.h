...
#ifndef LYRAMOTION_SWIFT_H
#define LYRAMOTION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LyraMotion",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10LyraMotion6Motion")
...
SWIFT_CLASS("_TtC10LyraMotion16MotionTransition")
...
@interface MotionTransition (SWIFT_EXTENSION(LyraMotion)) <UINavigationControllerDelegate>
...
@interface MotionTransition (SWIFT_EXTENSION(LyraMotion)) <UIViewControllerAnimatedTransitioning>
...
@interface MotionTransition (SWIFT_EXTENSION(LyraMotion)) <UIViewControllerInteractiveTransitioning>
...
@interface MotionTransition (SWIFT_EXTENSION(LyraMotion)) <UITabBarControllerDelegate>
...
@interface MotionTransition (SWIFT_EXTENSION(LyraMotion)) <UIViewControllerTransitioningDelegate>
...
@interface UIView (SWIFT_EXTENSION(LyraMotion))
/// A boolean that indicates whether motion is enabled.
@property (nonatomic) IBInspectable BOOL isMotionEnabled;
/// A boolean that indicates whether motion is enabled.
@property (nonatomic) IBInspectable BOOL isMotionEnabledForSubviews;
/// An identifier value used to connect views across UIViewControllers.
@property (nonatomic, copy) IBInspectable NSString * _Nullable motionIdentifier;
@end



@interface UIViewController (SWIFT_EXTENSION(LyraMotion))
